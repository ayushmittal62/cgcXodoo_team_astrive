...
export function SignInDev({ className, onGoogleSignIn }: SignInProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log("Sign-in successful:", data, error);
      if (data) {
              ...
              {!useEmailAuth ? (
                ...
                <form onSubmit={handleEmailLogin} className="space-y-4">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-full text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/30"
                    required
                  />
                  <input
                    type="password"
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full py-3 bg-white/20 hover:bg-white/30 disabled:bg-white/10 text-white rounded-full font-medium"
                  >
